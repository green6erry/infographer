...
/***/ function(module, exports, __webpack_require__) {
	...
	var makeBackgroundRed = __webpack_require__(15);
...
/***/ function(module, exports) {
	...
	$(function () {
	  ...
	  function doStuff(searchTerm) {
	    async.parallel({
	      marvel: function marvel(callback) {
	        getterfallMarvel(searchTerm, function (data) {
	          callback(null, data);
	        });
	      },
	      youTube: function youTube(callback) {
	        getTube(searchTerm, function (data) {
	          callback(null, data);
	        });
	      },
	      ombd: function ombd(callback) {
...
/***/ }
/******/ ]);
//# sourceMappingURL=infographer.1.0.0.js.map